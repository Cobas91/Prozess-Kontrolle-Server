...
router.post("/set", async (request, response) => {
    ...
    var Lagerbestand_pfad = body.Lagerbestand_Import.replace(Lagerbestand_file, "")
    //Lieferschein_Import
    ...
    var Lieferschein_pfad = body.Lieferschein_Import.replace(Lieferschein_file, "")
    ...
    var PowerBI_Checklisten_file = PowerBI_Checkliste_array[PowerBI_Checkliste_array.length -1]
    var PowerBI_Checklisten_pfad = body.powerbi_checklisten_pfad.replace(PowerBI_Checklisten_file, "")
    //PowerBI Systeme
    var PowerBI_Systeme_array = body.powerbi_systeme_pfad.split("/")
    var PowerBI_Systeme_file = PowerBI_Systeme_array[PowerBI_Systeme_array.length -1]
    var PowerBI_Systeme_pfad = body.powerbi_systeme_pfad.replace(PowerBI_Systeme_file, "")
    //PowerBI Status
